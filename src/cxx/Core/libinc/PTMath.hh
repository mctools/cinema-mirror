...
namespace Prompt {
  ...
  constexpr double const_neutron_rest_mass = 939.56542052; // MeV (source: NIST/CODATA 2018)
  constexpr double const_proton_rest_mass = 938.27208816; // MeV (source: NIST/CODATA 2018)
