...
:Scorer1D("ScorerMultiScat_"+ name, Scorer::ScorerType::PROPAGATE, std::make_unique<Hist1D>("ScorerMultiScat_"+ name, xmin, xmax, nxbins, linear)), m_lasteventid(0), m_p_counter(0), m_p_weight(0)
{ }
