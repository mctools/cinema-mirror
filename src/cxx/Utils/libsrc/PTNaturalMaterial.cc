...
Prompt::NaturalMaterial::NaturalMaterial()
:m_comp({  { 0, {{0, 1, 1.0, "n1"},} }, 
...
void Prompt::NaturalMaterial::parseCfgStr(const std::string & str)
{
...
std::vector<Prompt::IsotopeComposition>& Prompt::NaturalMaterial::getComposition(int Z)
{
