...
d2o = SQTrueHist('/data/yangni/cinemaRunData/2022_8_7/HW_D_1_NumBig/HW_R1/*ScororDeltaMomentum_SofQ_He_seed*.h5')
d2o_qtrue, d2o_s, d2o_err = d2o.fillHist(1, 85, xmin=0.1, xmax=120.0, numbin=150, linear=False)

v = SQTrueHist('/data/yangni/cinemaRunData/2022_8_7/HW_D_1_NumBig/V_R1/*ScororDeltaMomentum_SofQ_He_seed*.h5')
...
# d2oMS = MultiScatAnalysor('/data/yangni/cinemaRunData/2022_8_7/HW_D_1_NumBig/HW_R1/*ScororDeltaMomentum_SofQ_He_seed*.h5')
