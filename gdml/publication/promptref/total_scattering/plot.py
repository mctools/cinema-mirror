...
plt.scatter(q_HWb[0:1001:2], p_HWb[0:1001:2]/numPar2*2, marker='s', s=36, c='#e377c2', zorder=1, alpha=0.9)
plt.scatter(q_HWb1[0:1001:2], p_HWb1[0:1001:2]/numPar2, marker='o', s=34, c='#7f7f7f', zorder=1, alpha=0.9)
plt.scatter(q_HWb2[0:1001:10], p_HWb2[0:1001:10]/numPar2, marker='d', s=32, c='#9467bd', zorder=1, alpha=0.9)
plt.scatter(q_HWb4[0:1001:10], p_HWb4[0:1001:10]/numPar2, marker='>', s=32, c='#17becf', zorder=1, alpha=0.9)
plt.xlabel('Q, Å$^{-1}$') 
