...
parser.add_argument('-t', '--temperature', action='store', type=float, required=True,
                    dest='temp', help='temperature in kelvin')
parser.add_argument('-a', '--angel-scattering', action='store', type=float, required=True,
