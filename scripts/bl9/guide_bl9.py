...
from mcgd import JsonParser, GuideSectionCollection
import numpy as np
...
class MySim(PromptMPI):
    ...
    def makeWorld(self):
        ...
        mon_vol = Volume('monitor_vol', Box(50,50,1))
        ...
        ESpectrumHelper('eg_exit', 1e-5, 10, 100, groupID=2).make(mon_vol)
...
if __name__ == "__main__":
    ...
    if False:
        ...
        if sim.rank == 0:
            ...
            plt.figure()
            mon_exit_eg.plot(show=False,log=True,title=f'Energy')
